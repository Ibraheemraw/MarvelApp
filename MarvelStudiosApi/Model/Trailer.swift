...
struct Trailer {
    ...
    static func fetchVideos() -> [Trailer] {
        ...
        let trailer18 = Trailer(trailerName: "Guardians of the Galaxy Vol. 2", videoFileName: "GOTG2", trailerdescription: "Peter Quill and his fellow Guardians are hired by a powerful alien race, the Sovereign, to protect their precious batteries from invaders. When it is discovered that Rocket has stolen the items they were sent to guard, the Sovereign dispatch their armada to search for vengeance.", thumbnailFileName: "gotg2")
